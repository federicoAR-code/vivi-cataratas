...
const vehicles = [
  {
    ...
    features: ["Aire acondicionado", "WiFi", "Cargador USB", "Amplio baúl"],
  },
  {
    name: "Van Premium",
    capacity: "1-15",
    ...
    features: ["Aire acondicionado", "WiFi", "Asientos reclinables", "Amplio equipaje"],
    featured: true,
  },
  {
    name: "Minibús",
    ...
    features: ["Aire acondicionado", "WiFi", "Micrófono", "Sistema de audio", "Baño"],
  },
]
